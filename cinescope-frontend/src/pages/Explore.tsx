...
export const Explore: React.FC = () => {
  ...
  return (
    <div className="bg-[#020204] text-zinc-100 relative w-full overflow-x-hidden min-h-[100svh]">
          ...
          {!selectedId ? (
            ...
            >
              ...
              >
                ...
                <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-black uppercase tracking-tighter text-white leading-[0.85] mix-blend-screen drop-shadow-2xl">
                  Explore<br/>
              ...
              <div className="flex-1 flex flex-col md:flex-row gap-6 max-w-[1800px] mx-auto w-full">
                {loading ? (
                   Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="flex-1 min-h-[200px] md:min-h-[300px] rounded-[2rem] bg-white/[0.02] border border-white/[0.05] animate-pulse" />
                  ))
                ) : (
                  universes.map((uni, i) => (
                    <UniversePortal 
            ...
            >
              <button 
                onClick={goBack} 
                className="fixed top-20 left-4 md:left-8 z-50 px-6 py-3 min-h-[44px] rounded-full bg-white/5 backdrop-blur-md border border-white/10 text-white text-xs font-bold uppercase tracking-[0.2em] hover:bg-white/10 transition"
              >
                ← Return to Nexus
              </button>
              ...
              {data ? (
                <>
                  ...
                  <section className="min-h-[100svh] flex items-center justify-center relative">
                    ...
                    >
                      <h1 className="text-4xl sm:text-7xl md:text-[10rem] font-black uppercase tracking-tighter leading-none mb-6 drop-shadow-[0_20px_50px_rgba(0,0,0,1)]">
                        {data.name}
                      </h1>
                  ...
                  <section className="relative w-full py-16 md:py-40 overflow-hidden">
                    <div className="max-w-[1400px] mx-auto px-6 relative">
                       <h2 className="text-3xl md:text-5xl lg:text-8xl font-black uppercase tracking-tighter text-center mb-16 md:mb-32 mix-blend-overlay opacity-30">
                         The Continuity
                       </h2>
